...
GM_addStyle(css);
	...
	//TODO: pages.json
       ...
       sidebar.appendChild(sidebarUl);
	    ...
	    let toggle = '<span class="megamod-toggle"><input type="checkbox" class="tgl megamod-tgl" id="megamod-checkbox" /><label class="tgl-btn" for="megamod-checkbox"></label></span>'
