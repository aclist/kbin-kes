...
In addition, safeGM natively reimplements some function calls that were dropped in GM 4.0 but are available in other extensions, namely, (as of this
writing, `GM_addStyle`).
...
- SHOULD: https://www.conventionalcommits.org/en/v1.0.0/[conventional commits]
- SHOULD: 80 line width
