...
// @connect      github.com
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/helpers/safegm.user.js
// @require      https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.7.0/highlight.min.js
// @require      http://code.jquery.com/jquery-3.4.1.min.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/code-highlighting.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/dropdown.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/easy-emoticon.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/hide-logo.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/hide-sidebar.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/hide-thumbs.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/hide-votes.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/improved-collapsible-comments.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/instance-names.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/kbin-federation-awareness.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/kbin-mod-options.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/label.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/mail.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/nav-icons.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/notifications-panel.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/report-bug.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/subs.user.js
// @require      https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/mods/timestamp.user.js
// @resource     kes_layout https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/helpers/ui.json
// @resource     kes_json https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/helpers/manifest.json
// @resource     kes_css https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/helpers/kes.css
// @downloadURL  https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/kes.user.js
// @updateURL    https://github.com/aclist/kbin-kes/raw/pre-release/2.0.4/kes.user.js
// ==/UserScript==
...
const branch = "pre-release/2.0.4"
